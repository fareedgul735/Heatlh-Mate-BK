...
const sendOtpNotificationForgetPassword = async (email, otp) => {
  try {
    const mailOptions = {
      ...
      to: email,
      subject: "💙 HealthMate | Password Reset Verification Code",
      html: `
  <div style="
  ...
  ">
    ...
    ">
      ...
      <p style="
        ...
        font-size: 14px;
        margin-bottom: 22px;
      ">Use the OTP below to reset your password securely.</p>
      ...
      <p style="font-size: 12px; color: #94a3b8;">
        ❤️ We respect your privacy. HealthMate shares nothing without your permission.<br><br>
